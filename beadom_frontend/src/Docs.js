...
class Docs extends React.Component{
    render(){
        return(
        <>
            <div className=" overflow-y-auto overflow-x-hidden scrollbar w-screen flex flex-col items-start  justify-start flex-none h-screen bg-neutral-700 text-neutral-400 relative ">
                ...
                <video src="/docfiles/video.mp4" itemType="video/mp4" controls className="w-[calc(100%-32px)] max-w-5xl m-4 rounded-3xl transition-all"></video>
            </div>
        </>
        );
    }
